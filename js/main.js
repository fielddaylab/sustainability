...
function calculateScore(){
	return (timeSurvived + (upgrades.irrigateAtNight.count * 2) + (satisfaction * 10) +
			(upgrades.irrigateLess.count * 2) + (upgrades.dualFlushToilet.count * 2) + (upgrades.faucetSensors.count * 2) + 
